       ...
       C-DIV.
           COMPUTE RESULT-RE = Z1-RE * Z2-RE + Z1-IM * Z2-IM
           COMPUTE RESULT-RE = RESULT-RE / 
                               (Z2-RE**2 + Z2-IM**2)
           COMPUTE RESULT-IM = Z1-IM * Z2-RE - Z1-RE * Z2-IM
           COMPUTE RESULT-IM = RESULT-IM / 
                              (Z2-RE**2 + Z2-IM**2)
       .
       C-ABS.
           MOVE ZEROS TO RESULT-IM
           COMPUTE RESULT-RE = Z1-RE**2 + Z1-IM**2
           COMPUTE RESULT-RE = FUNCTION SQRT(RESULT-RE)
       .
       C-CONJUGATE.
           MOVE Z1-RE TO RESULT-RE
